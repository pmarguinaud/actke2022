...
& PKTROV, PKQROV, PKQLROV, PKUROV, PXTROV, PXUROV, PNBVNO, PNEBS, PQCS, PNEBS0, PQCS0, PCOEFN, PFECT, PFECTI, PECT1, PTPRDY, PEDR &
& )
...
#include "aclender.intfb.h"
  ...
  IF (LECTFL) THEN
    ...
    CALL FL2HL(KIDIA, KFDIA, KLON, 1, KLEV, PAPRS, PAPRSF, PECT, ZECT, 1, 'FL2HL  ')
  ELSE
  ...
  IF (LECTFL) THEN
    ...
    ! puis le flux
    WRITE(*, *) "PECT1", PECT1(20, 14 : KLEV)
    WRITE(*, *) "PAPRS", PAPRS(20, 13 : KLEV)
    WRITE(*, *) "PAPRSF", PAPRSF(20, 14 : KLEV)
    WRITE(*, *) "ZECT1", ZECT1(20, 13 : KLEV)
    
    
    CALL HL2FL(KIDIA, KFDIA, KLON, 1, KLEV, PAPRS, PAPRSF, ZECT1, 1, PECT1, 'HL2FL  ')
    DO JLEV=KTDIAT,KLEV
      DO JLON=KIDIA,KFDIA
        ZDET(JLON, JLEV) = (PECT1(JLON, JLEV) - PECT(JLON, JLEV)) / TSPHY
      END DO
    END DO
    WRITE(*, *) "ZDET", ZDET(20, 14 : KLEV)
    WRITE(*, *) "PECT1", PECT1(20, 14 : KLEV)
    WRITE(*, *) "PECT", PECT(20, 14 : KLEV)
    
    ! Production dynamique
    CALL HL2FL(KIDIA, KFDIA, KLON, 1, KLEV, PAPRS, PAPRSF, ZPRDY, 1, PTPRDY, 'HL2FL  ')
    ! EDR
    CALL HL2FL(KIDIA, KFDIA, KLON, 1, KLEV, PAPRS, PAPRSF, ZEDR, 1, PEDR, 'HL2FL  ')
  ELSE
    !  ECT toujours sur les demi-niveaux
    DO JLEV=KTDIAT,KLEV
      !DEC$ IVDEP
  ...
  !IF (JLON == 20
  WRITE(*, *) "PFECT", PFECT(20, 14 : KLEV)
  WRITE(*, *) "ZDET", ZDET(20, 14 : KLEV)
  WRITE(*, *) "ZDELPSG", ZDELPSG(20, 14 : KLEV)
  DO JLEV=KTDIAT,KLEV
    DO JLON=KIDIA,KFDIA
